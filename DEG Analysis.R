##comparison Dgree centrality
rm(list=ls())
library(sqldf)
file_name_tumor=paste("E:/20180907/clinical/combined_data.csv", sep="")
tumor_Data<-read.table(file_name_tumor, header=TRUE, sep=",")
colnames(tumor_Data)

DEG_list <- as.data.frame(read.csv("E:/20180907/DEG_1000_list.csv"))
...
file_name=paste("E:/20180907/DEG_1000.csv", sep="")
